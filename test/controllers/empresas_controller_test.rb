...
class EmpresasControllerTest < ActionController::TestCase
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post :create, empresa: { direccion: @empresa.direccion, email: @empresa.email, nombre: @empresa.nombre, rif: @empresa.rif, telefono: @empresa.telefono }
    end
  ...
  test "should update empresa" do
    patch :update, id: @empresa, empresa: { direccion: @empresa.direccion, email: @empresa.email, nombre: @empresa.nombre, rif: @empresa.rif, telefono: @empresa.telefono }
    assert_redirected_to empresa_path(assigns(:empresa))
  end
